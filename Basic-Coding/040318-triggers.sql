...
-- 7. Create a trigger on the Staff Table that ensures staff are only added one at a time. Call this trigger "Customer_Insert_Limit"
...
-- 9. Create a trigger on the activity table so that a student cannot be added to a club if their balance is over $600
